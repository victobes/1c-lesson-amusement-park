...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ПродажаБилетаПозицииПродажи.Номенклатура.ВидАттракциона КАК НоменклатураВидАттракциона,
	...
	Пока Выборка.Следующий() Цикл
		...
		Движение.ВидАттракциона               = Выборка.НоменклатураВидАттракциона;
...
Функция ДоляНакапливаемыхБаллов(СуммаПокупокКлиента)
	...
	Запрос.УстановитьПараметр("Период", Дата); // Периодичность - день, поэтому не напрягаемся с моментом времени
